...
(function (global) {
  ...
  const ROWS = [
    ...
    // ------------------------------- South Asian vegetables and staples ----
    ['okra', 'Okra (Bhindi)', 'vegetables', 'cups', 100, 33, 1.9, 7.5, 0.2, 3.2, 1.5, 7, 0, 6, 'Green beans or courgette', 'Young, small pods (less slimy)', 'The star of the dish -- cooked dry so it never goes slimy', { vitC: 23, magnesium: 57 }],
    ['bottle-gourd', 'Bottle Gourd (Lauki)', 'vegetables', 'cups', 116, 14, 0.6, 3.4, 0.02, 0.5, 1.6, 2, 0, 3, 'Courgette or ash gourd', 'Tender young gourd', 'Light, cooling body that soaks up the masala'],
    ['bitter-gourd', 'Bitter Gourd (Karela)', 'vegetables', 'cups', 100, 17, 1, 3.7, 0.17, 2.8, 1.95, 5, 0, 8, 'Ridge gourd, for a milder dish', 'Salted and rested to draw out bitterness', 'Its bitterness is the point -- balanced with jaggery and sour', { vitC: 84 }],
    ['ridge-gourd', 'Ridge Gourd (Turai)', 'vegetables', 'cups', 100, 20, 1.2, 4.4, 0.2, 1.1, 2, 3, 0, 5, 'Bottle gourd or courgette', 'Peeled lightly, ridges left on', 'Soft, sweet body that cooks quickly'],
    ['tinda', 'Tinda (Apple Gourd)', 'vegetables', 'pieces', 60, 21, 1.4, 4.3, 0.2, 1, 2.2, 3, 0, 6, 'Courgette or bottle gourd', 'Small tender tinda', 'Mild gourd that carries spice well'],
    ['fenugreek-leaves', 'Fenugreek Leaves (Methi)', 'vegetables', 'cups', 40, 49, 4.4, 6, 0.9, 1.1, 0, 76, 0, 12, 'Spinach with a pinch of kasuri methi', 'Fresh methi, thick stems removed', 'Fresh bitterness and aroma -- the signature of the dish', { iron: 1.9, calcium: 176 }],
    ['mustard-greens', 'Mustard Greens (Sarson)', 'vegetables', 'cups', 56, 27, 2.9, 4.7, 0.4, 3.2, 1.3, 20, 0, 8, 'Spinach plus a little rocket', 'Young leaves, slow cooked', 'Peppery green that defines the dish', { iron: 1.6, calcium: 115, vitA: 151 }],
    ['drumstick', 'Drumstick (Moringa)', 'vegetables', 'pieces', 50, 37, 2.1, 8.5, 0.2, 3.2, 0, 42, 0, 10, 'Green beans', 'Tender pods, cut into fingers', 'Slow-release flavour into the gravy', { vitC: 141 }],
    ['raw-banana', 'Raw Banana (Plantain)', 'vegetables', 'pieces', 120, 122, 1.3, 32, 0.4, 2.3, 15, 4, 0, 5, 'Potato', 'Green plantain, skin on where possible', 'Starchy body, a common potato substitute'],
    ['colocasia', 'Colocasia (Arbi)', 'vegetables', 'cups', 130, 112, 1.5, 26, 0.2, 4.1, 0.4, 11, 0, 8, 'Potato or yam', 'Boiled first, then crisped', 'Creamy starch that crisps beautifully'],
    ['yam', 'Yam (Suran)', 'vegetables', 'cups', 136, 118, 1.5, 28, 0.2, 4.1, 0.5, 9, 0, 9, 'Potato or colocasia', 'Well-cooked yam (raw yam irritates the throat)', 'Dense, satisfying starch', { potassium: 816 }],
    ['cluster-beans', 'Cluster Beans (Guar)', 'vegetables', 'cups', 100, 46, 3.2, 10.8, 0.4, 3.2, 0, 6, 0, 8, 'Green beans', 'Young, snappy pods', 'Firm bite and gentle bitterness'],
    ['ash-gourd', 'Ash Gourd (Petha)', 'vegetables', 'cups', 132, 13, 0.4, 3, 0.2, 2.9, 0, 111, 0, 3, 'Bottle gourd', 'Fresh white flesh', 'Very light, cooling body'],
    ['radish', 'Radish (Mooli)', 'vegetables', 'pieces', 100, 16, 0.7, 3.4, 0.1, 1.6, 1.9, 39, 0, 4, 'Turnip or kohlrabi', 'Young radish with its greens', 'Peppery crunch that mellows on cooking', { vitC: 15 }],
    ['amaranth-leaves', 'Amaranth Leaves (Chaulai)', 'vegetables', 'cups', 28, 23, 2.5, 4, 0.3, 2.2, 0, 20, 0, 6, 'Spinach', 'Young red or green amaranth', 'Iron-rich green that wilts down fast', { iron: 2.3, calcium: 215 }],
    ['green-beans', 'Green Beans', 'vegetables', 'cups', 110, 31, 1.8, 7, 0.1, 2.7, 3.3, 6, 0, 8, 'Cluster beans or peas', 'Snappy fresh beans', 'Crunch and colour'],
    ['poha', 'Poha (Flattened Rice)', 'grains', 'cups', 100, 346, 6.6, 77, 1.2, 2.4, 0, 8, 0, 8, 'Broken wheat or semolina', 'Thick red poha (more fibre)', 'Rinsed briefly so it softens without turning to paste', { iron: 20 }],
    ['sabudana', 'Sabudana (Tapioca Pearls)', 'grains', 'cups', 150, 358, 0.2, 88, 0.02, 0.9, 0, 1, 0, 12, 'Samak rice', 'Soaked overnight, drained fully', 'Pearls that must stay separate, never sticky'],
    ['besan', 'Besan (Gram Flour)', 'legumes', 'cups', 92, 387, 22, 58, 6.7, 11, 11, 64, 0, 12, 'Chickpeas, ground', 'Freshly milled besan', 'Protein-rich binder and batter base', { iron: 4.9, magnesium: 166 }],
  ...
  const ALIASES = {
    ...
    'bhindi': 'okra', 'bhendi': 'okra', 'ladyfinger': 'okra', "lady's finger": 'okra',
    'lauki': 'bottle-gourd', 'dudhi': 'bottle-gourd', 'ghiya': 'bottle-gourd', 'calabash': 'bottle-gourd',
    'karela': 'bitter-gourd', 'bitter melon': 'bitter-gourd',
    'turai': 'ridge-gourd', 'tori': 'ridge-gourd',
    'methi leaves': 'fenugreek-leaves', 'fresh methi': 'fenugreek-leaves',
    'sarson': 'mustard-greens', 'saag': 'mustard-greens',
    'moringa': 'drumstick', 'sahjan': 'drumstick',
    'kacha kela': 'raw-banana', 'plantain': 'raw-banana',
    'arbi': 'colocasia', 'taro': 'colocasia',
    'suran': 'yam', 'jimikand': 'yam',
    'guar': 'cluster-beans', 'gawar': 'cluster-beans',
    'petha': 'ash-gourd', 'winter melon': 'ash-gourd',
    'mooli': 'radish', 'daikon': 'radish',
    'chaulai': 'amaranth-leaves',
    'french beans': 'green-beans',
    'gram flour': 'besan', 'chickpea flour': 'besan',
    'flattened rice': 'poha', 'aval': 'poha',
    'tapioca pearl': 'sabudana', 'sago': 'sabudana',
